...
list_preflight_packages="git portmap nfs-utils nfs-client nfs-tools docker"
...
# non-standard repos required for
package installation
additional_repos='https://download.docker.com/linux/centos/docker-ce.repo'


# packages to install
list_general_packages='git-core ntp vim rsync pigz gdisk aria2 yum-versionlock'
list_docker_ce_packages='docker-ce'
